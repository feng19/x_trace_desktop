...
download-macos:
	wget https://github.com/feng19/x_trace/releases/download/v0.2.0/xtrace_macos -O src-tauri/binaries/xtrace-x86_64-apple-darwin
	chmod a+x src-tauri/binaries/xtrace-x86_64-apple-darwin
	wget https://github.com/feng19/x_trace/releases/download/v0.2.0/xtrace_macos_aarch64 -O src-tauri/binaries/xtrace-aarch64-apple-darwin
	chmod a+x src-tauri/binaries/xtrace-aarch64-apple-darwin

download-windows:
	wget https://github.com/feng19/x_trace/releases/download/v0.2.0/xtrace_x86_64-pc-windows-msvc.exe -O src-tauri/binaries/xtrace-x86_64-windows.exe